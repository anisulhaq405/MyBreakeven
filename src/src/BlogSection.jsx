...
import {day3Posts} from "./day3Posts.js";

const allPosts = [...articleList, ...day1Posts, ...day2Posts, ...day3Posts].sort((a, b) => String(b.published).localeCompare(String(a.published)));
