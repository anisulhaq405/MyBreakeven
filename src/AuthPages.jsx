...
export function DashboardPage() {
  ...
  return <section className="dashboard-page">
    ...
    {isPro && <section className="dashboard-pro-entry" aria-label="Pro advanced break-even analysis"><div><span>PRO ADVANCED ANALYSIS</span><h2>Test the numbers behind your break-even plan</h2><p>Explore margin of safety, price and volume changes, capacity, and a 12-month profit outlook using your own assumptions.</p></div><a className="page-button" href="/#pro-analysis">Open advanced analysis</a></section>}
