...
describe("subscription entitlements", () => {
  ...
  it("defines the approved Pro limits", () => expect(PLAN_LIMITS.pro).toEqual({ savedScenarios: 100, comparisons: 3, exports: true, costDrift: true, advancedAnalysis: true, forecasts: true, decisionStudio: true }));
